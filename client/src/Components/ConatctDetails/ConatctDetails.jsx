        ...
        <div className="ConatctDetailsMain">
            <div className="ConatctDetails">
                <Box
                    ...
                    autoComplete="off"
                >
                    <InputLabel sx={{fontWeight:'bold'}} htmlFor="standard-adornment-amount">
                        CONTACT DETAILS
                    </InputLabel>
                    <TextField 
                        sx={{
                    ...
                    <InputLabel sx={{fontWeight:'bold'}} htmlFor="standard-adornment-amount">ADDRESS</InputLabel>
                    <TextField 
                        sx={{
                            "& input": {
                                fontWeight: 'bold',
                            }
                        }}id="outlined-basic" label="Pin Code*" variant="outlined" 
                        value={pincode}
                        onChange={(e) => {
                            const re = /^[0-9\b]+$/;
                            if(pincode.length <= 5){
