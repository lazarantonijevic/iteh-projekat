        ...
        <div className='TrendingProducts'>
            <div className='TrendingProductsHeading'>
                ...
                <div className='TrendingProductsCategory'>
                    <div onClick={() => navigate("/category/men-jeans&&men-t-shirts/products")}><p id='tag'>Men</p></div>
                    <div onClick={() => navigate("category/women-kurtas-suits&&women-tops/products")}><p id='tag'>Women</p></div>
