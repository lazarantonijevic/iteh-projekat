  ...
  return (
    <div>
      <div className='NavBarMain'>
        ...
        <div onClick={() => navigate("/category/men-jeans&&men-t-shirts/products")} id="home1">Men</div>
        <div onClick={() => navigate("/category/women-kurtas-suits&&women-tops/products")} id="home1">Women</div>
